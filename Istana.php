...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="display-4">ISTANA BOGOR</h1>
                    <p class="kedua">KOTA BOGOR</p>
                    <p class="lead">Istana Bogor merupakan salah satu dari enam Istana Presiden Republik Indonesia yang mempunyai keunikan tersendiri dikarenakan aspek historis, kebudayaan, dan faunanya. Salah satunya adalah keberadaan rusa-rusa yang didatangkan langsung dari Nepal dan tetap terjaga dari dulu sampai sekarang.<br></p>
                    <p class="lead">Harga Tiket Masuk Rp. 15.000</p>
                    <p class="lead"> Jl. Ir. H. Juanda, Paledang, Kota Bogor, Jawa Barat</p>
                    <a class="btn tombol-button1 text-light" href="https://www.youtube.com/watch?v=KDfylSB158k" role="button">&nbsp; Cek&nbsp;</a>
                ...
                <div class="col-md-6 mt-5">
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded">
                            ...
                            <div class="carousel-item">
                            <video controls> <source src="images\i3.mp4" type="video/mp4"/></video>
                                <div class="carousel-caption d-none d-md-block">
                                </div>
                            </div>
                        </div>
