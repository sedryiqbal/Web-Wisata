...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="display-4">MUSEUM ZOOLOGI</h1>
                    <p class="kedua">KOTA BOGOR</p>
                    <p class="lead">Museum Zoologi Bogor adalah museum yang terletak di Bogor, memiliki koleksi yang berkaitan dengan dunia satwa seperti berbagai spesimen yang diawetkan maupun fosil hewan.<br></p>
                    <p class="lead">Harga Tiket Masuk Rp. 15.000 (Lokal), Rp.25.000 (Asing)</p>
                    <p class="lead">Jl. Ir. H. Juanda No.9, RT.04/RW.02, Paledang, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat 16911</p>
                    <a class="btn tombol-button1 text-light" href="https://www.youtube.com/watch?v=C9kvdNXtlX8" role="button">&nbsp; Cek&nbsp;</a>
                ...
                <div class="col-md-6 mt-5">
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded">
                            ...
                            <div class="carousel-item">
                            <video controls> <source src="images\m3.mp4" type="video/mp4"/></video>
                                <!-- <img src="images\m3.mp4" class="d-block w-100" alt="..."> -->
                                <div class="carousel-caption d-none d-md-block">
                                </div>
                            </div>
                        </div>
