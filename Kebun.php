...
<body>
    ...
    <!-- Jumbotron -->
    <!-- Penjelasan Wisata Kebun Raya Kota Bogor -->
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="display-4">KEBUN RAYA</h1>
                    <p class="kedua">KOTA BOGOR</p>
                    <p class="lead">Kebun Raya Bogor atau Kebun Botani Bogor adalah sebuah kebun botani besar yang terletak di Kota Bogor, Indonesia. Luasnya mencapai 87 hektar dan memiliki 15.000 jenis koleksi pohon dan tumbuhan.Saat ini Kebun Raya Bogor ramai dikunjungi sebagai tempat wisata, terutama hari Sabtu dan Minggu.<br></p>
                    <p class="lead">Harga Tiket Masuk Rp. 30.000</p>
                    <p class="lead">Jl. Ir. H. Juanda No.13, Paledang, Kecamatan Bogor Tengah, Kota Bogor, Jawa Barat 16122 </p>
                    <a class="btn tombol-button1 text-light" href="https://www.youtube.com/watch?v=Cv7KEeT_hcw" role="button">&nbsp; Cek&nbsp;</a>
                ...
                <!-- End Jumbotron -->
                <!-- Carousel -->
                 <!-- Foto dan Video Kebun Raya Bogor -->
                <div class="col-md-6 mt-5">
                    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded">
                            ...
                            <div class="carousel-item">
                            <video controls> <source src="images\k3.mp4" type="video/mp4"/></video>
                                <div class="carousel-caption d-none d-md-block">
                                </div>
                            </div>
                        </div>
